...
$product_list = "";
$sql = mysql_query("SELECT * FROM products WHERE category='Centerpiece'");
...
if ($productCount > 0) {
    while($row = mysql_fetch_array($sql)){
        ...
        $product_list .= '<table width="100%" cellspacing="0" cellpadding="6" bordercolor="#FFFFFF" frame="below" rules="none">
          <tr>


          <td width="20%" align="center">Product ID:' . $pid. '  </td><td width="20%"><strong>'.$product_name.'</strong>  </td><td width="15%">Php'.$price.'</td><td width="15%">'.$category.'</td><td width="20%">Added '.$date_added.'</td><td width="10%" align="right"><a href="inventory_edit.php?pid='.$pid.'"><b><img src="../style/edit.png"  width="40" height="40"  /></a></td><td width="20%" align="right"> <a href="inventory_list.php?deleteid='.$pid.'"><b><img src="../style/delete.png"  width="40" height="40"  /></a></td>
...
if ($packageCount > 0) {
    while($row = mysql_fetch_array($sql)){
        ...
        $package2 .= '
         <li><a href="manage'.$packagename.'.php"><span>'.$packagename.'</span></a></li>
...
<head>
    ...
    <title>Manage <?php echo $category ?></title>
    ...
    <div id='cssmenu'>
        <ul>
            ...
            <li><a href='Package.php'><span>Packages</span></a>
                <ul>
                    <?php echo $package2 ?>
                    <li class='has-sub last'><a href='managePackage.php'><span>Edit Package</span></a>
    ...
    <div class = "content2">
        ...
        <div id="pageContent">
            <div align="left" style="margin-left:24px;">
                <h2>List of <?php echo $category; ?></h2>
