    ...
    <div class = "content2">
        ...
        <div id="pageContent">
            <div align="left" style="margin-left:24px;">
                ...
                <form action="Package.php" enctype="multipart/form-data" name="myForm" id="myForm" method="post">
                    <table width="90%" border="0" cellspacing="0" cellpadding="6">
                        <tr>
                            <td width="20%" align="right">Package Name</td>
                            <td width="80%"><label>
                                <input name="packagename" type="text" id="product_name" size="64" />
                            </label></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><textarea name="packagedesc" id="details" cols="64" rows="5"></textarea></td>
                        </tr>
                        <tr>
