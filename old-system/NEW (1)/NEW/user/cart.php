...
if (!isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) < 1) {
    ...
    foreach ($_SESSION["cart_array"] as $each_item) { 
		...
		setlocale(LC_MONETARY, "de_DE");    //en_US
       // $pricetotal = money_format("%10.2n", $pricetotal);
		...
		$cartOutput .= "<tr>";
		$cartOutput .= '<td><a href="product.php?pid=' . $item_id . '">' . $product_name . '</a><br /><img src="../inventory_images/' . $item_id . '.jpg" alt="' . $product_name. '" width="40" height="52" border="1" /></td>';
	...
	$cartTotal = "<div style='font-size:25px; margin-top:12px;' align='right'>Cart Total : ".$cartTotal." PHP</div>";
    // Finish the Paypal Checkout Btn
	$pp_checkout_btn .= '<form action="reservation.php" method="post">
	<input type="hidden" name="custom" value="' . $product_id_array . '">
	<input type="hidden" name="pid" value="' . $item_id . '">
            ...
            <div style="margin:24px; text-align:left;">
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="6">
                    <tr align="center">
                        ...
                        <td width="41%" bgcolor="#666666"><strong>Product Description</strong></td>
                        <td width="13%" bgcolor="#666666"><strong>Unit Price</strong></td>
                        <td width="12%" bgcolor="#666666"><strong>Quantity</strong></td>
                        <td width="7%" bgcolor="#666666"><strong>Total</strong></td>
