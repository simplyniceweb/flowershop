...
if (isset($_POST['packID'])) {
    ...
    include "../storescripts/connect_to_mysql.php";
    $packID1 = preg_replace('#[^0-9]#i', '', $_POST['packID']);
    ...
    if ($productCount > 0) {
        ...
        echo "That Package does not exist.";
        exit();
    }
        ...
        <form name="order" action="processreserve.php" onsubmit="return validateForm()" method="post">
            <table width="100%" border="0" cellspacing="0" cellpadding="30">
                <tr>
                    ...
                    <td width="10%" valign="top" align="center"><p><img src="../package_images/<?php echo $packID1; ?>.jpg" width="100" style="border:#FFFFFF 1px solid;" height="100" alt="<?php echo $packagename; ?>" /><br />

                        <a href="../package_images/<?php echo $packID1; ?>.jpg" target="_blank"></a></p>
                    </td>
                    <td width="30%" valign="top"><h3><?php echo"<b>Package Name:&nbsp;</b>" .$packagename1; ?></h3>
                        <p>


                            <?php echo"<b>Description:&nbsp;</b>" .$packagedesc1; ?> <br />
                            <br />
