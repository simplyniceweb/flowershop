...
if (isset($_GET['resid'])) {
    $targetID = $_GET['resid'];
    $sql = mysql_query("SELECT * FROM products a, reservation b WHERE a.pid=b.pid AND b.resid='$targetID' LIMIT 1");
...
<div class = "content2">
    ...
    <div id="pageContent"><br />
        ...
        <form action="rescheduling.php"  name="myForm" id="myform" method="post">
            <table width="90%" border="0" cellspacing="0" cellpadding="6">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="rescheduling.php?status=<?php echo $status ?>"><img src="../style/resched.png" height="25" width="25">Rescheduling</a>
                    ...
                    <td>
                        ...
                        <a href="cancelation.php?status=<?php echo $status; ?>"><img src="../style/cancel.png" height="25" width="25">Cancel order</a>

                    </td>
                    <td>

                        <a href="viewbill.php?resid=<?php echo $resid ?>">View Billing Statement </a>
