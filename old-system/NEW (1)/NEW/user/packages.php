...
if (isset($_GET['packID'])) {
    ...
    $packID1 = preg_replace('#[^0-9]#i', '', $_GET['packID']);
    // Use this var to check to see if this ID exists, if yes then get the product
    // details, if no then exit this script and give message why
    $sql = mysql_query("SELECT * FROM packages WHERE packID='$packID1' LIMIT 1");
...
<div class = "content1">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="40">
        <tr>
            <td width="19%" valign="top" align="center"><p><img src="../package_images/<?php echo $packID1; ?>.jpg" width="250" style="border:#FFFFFF 1px solid;" height="250" alt="<?php echo $packagename; ?>" /><br />

                <a href="package_images/<?php echo $packID; ?>.jpg" target="_blank"></a></p>
            </td>
            <td width="81%" valign="top"><h3><?php echo"<b>Package Name:&nbsp;</b>" .$packagename1; ?></h3>
                <p>
                    <?php echo"<b>Package Description:&nbsp;</b>" .$packagedesc1; ?>
                    <br />
                </p>
                <form id="form1" name="form1" method="post" action="reservation2.php">
                    <input type="hidden" name="packID" id="packID" value="<?php echo $packID1; ?>" />
