<style>
	ul.advert-ul li { list-style-type: none; float: left; }
</style>
<ul class="advert-ul">
<?php if($result > 0 ) { foreach($advert as $ads) { ?>
<li>
<?php if($session['user_level'] == 1){ ?>
<i class="specific-delete glyphicon glyphicon-remove" data-entry-id="<?php echo $ads->id; ?>" data-type="advert" style="top:-60px;left:20px;position:relative;background: #f1f1f1;"></i>
<?php } ?>
